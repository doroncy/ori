...
var mongoose = require('mongoose'),
  ...
  orderSocket = require('./order.socket'),
...
function createOrder(req, res) {
  ...
  order
    ...
    .then(function() {
      return Order
        .findOne({ _id: dbOrder.id })
        .populate({path: 'user', select:'name office officeName email phone'})
        .exec()
        .then(function(orderData) {
          orderSocket.sendOrderCreatedMsg({
            order: orderData
          });
          return orderData;
        });
...
function sendThankYouEmail(email) {
  if (email) {
    transporter.sendMail({
      from: 'orisfoods@gmail.com',
      to: email,
      subject: 'הזמנתך התקבלה, האוכל בדרך...',
      html: getThankYouMailContent()
    });
  }
}

function getThankYouMailContent() {
...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body dir="rtl" style="width: 100% !important; min-width: 100%; -webkit-text-size-adjust: 100%; -ms-text-size-adjust: 100%; color: #222222; font-family: 'Helvetica', 'Arial', sans-serif; font-weight: normal; text-align: left; line-height: 19px; font-size: 14px; margin: 0; padding: 0;">
  <style type="text/css">
  a:hover {
...
<table class="container" style="border-spacing: 0; border-collapse: collapse; vertical-align: top; text-align: inherit; width: 580px; margin: 0 auto; padding: 0;">
  ...
  <table class="twelve columns center" style="border-spacing: 0; border-collapse: collapse; vertical-align: top; text-align: center; width: 580px; margin: 0 auto; padding: 0;"><tr style="vertical-align: top; text-align: left; padding: 0;" align="left"><td class="center header-img-wrap" style="word-break: break-word; -webkit-hyphens: auto; -moz-hyphens: auto; hyphens: auto; border-collapse: collapse !important; vertical-align: top; text-align: center; color: #222222; font-family: 'Helvetica', 'Arial', sans-serif; font-weight: normal; line-height: 19px; font-size: 14px; border-bottom-width: 1px; border-bottom-color: #ccc; border-bottom-style: solid; margin: 0; padding: 0px 0px 10px;" align="center" valign="top">
  <img class="header-img" src="http://oris.herokuapp.com/assets/images/4ae92c16.ori-menu-logo.png" style="outline: none; text-decoration: none; -ms-interpolation-mode: bicubic; width: auto; max-width: 100%; float: none; clear: both; display: block; margin: auto;" align="none" /></td>
  ...
  <br /></td>
  </tr><tr style="vertical-align: top; text-align: left; padding: 0;" align="left"><td class="right-text content-body" style="word-break: break-word; -webkit-hyphens: auto; -moz-hyphens: auto; hyphens: auto; border-collapse: collapse !important; vertical-align: top; text-align: right; color: #222222; font-family: 'Helvetica', 'Arial', sans-serif; font-weight: normal; line-height: 19px; font-size: 14px; margin: 0; padding: 0px 0px 10px;" align="right" valign="top">
  <h6 class="right-text" style="color: #222222; font-family: 'Helvetica', 'Arial', sans-serif; font-weight: normal; text-align: right; line-height: 1.3; word-break: normal; font-size: 20px; margin: 0; padding: 0;" align="right">
  תודה. הזמנתך התקבלה, האוכל בדרך
</h6>
</td>
</tr></table></td>
</tr></table></td>
